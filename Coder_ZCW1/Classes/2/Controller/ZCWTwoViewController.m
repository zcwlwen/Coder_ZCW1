...
@interface ZCWTwoViewController ()

@end

@implementation ZCWTwoViewController
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [UIView animateWithDuration:1.0 delay:0 options:UIViewAnimationOptionRepeat animations:^{
        one.alpha = 0;
        one.center = CGPointMake(self.view.center.x, 600);
